<%@ Page Language="C#" AutoEventWireup="true" Inherits="Departamento_FrmDepartamentoAdmin" Codebehind="FrmDepartamentoAdmin.aspx.cs" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="Departamento" HeaderText="Depatamento" />
