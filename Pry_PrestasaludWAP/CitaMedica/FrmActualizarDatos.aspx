<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmActualizarDatos.aspx.cs" Inherits="Pry_PrestasaludWAP.CitaMedica.FrmActualizarDatos" %>
                            ...
                            <div class="table-responsive">
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="width: 2%"></td>
                                        <td style="width: 15%;">
                                            <h5>Nro. Documento:<span style="color: red">*</span></h5>
                                        </td>
                                        <td style="width: 29%">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <h5>Fecha Nacimiento:<span style="color: red">*</span></h5>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4">
                                            <asp:TextBox ID="txtDireccion" runat="server" Width="100%" CssClass="form-control upperCase" MaxLength="250" Height="50px" TextMode="MultiLine" TabIndex="13"></asp:TextBox>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="table-responsive">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6">
                                            <asp:TextBox ID="txtDireccionBen" runat="server" Width="100%" CssClass="form-control upperCase" MaxLength="80" Height="50px" TextMode="MultiLine" TabIndex="33"></asp:TextBox>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                                ...
                                                <asp:GridView ID="grdvDatos" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-bordered table-hover table-responsive" DataKeyNames="CodigoBen,TipoDocumentoBen,NumeroDocumentoBen,GeneroBen,EstadoCivilBen,FechaNacimientoBen,ProvinciaBen,CiudadBen,DireccionBen,FonoCasaBen,FonoOficinaBen,CelularBen,EmailBen,ParentescoCod,Estado,PrimerNombre,SegundoNombre,PrimerApellido,SegundoApellido" ShowHeaderWhenEmpty="True" Width="100%" TabIndex="43">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Editar">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="imgSelecc" runat="server" Height="15px" ImageUrl="~/Botones/modificar.png" OnClick="imgSelecc_Click" />
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                    </Columns>
