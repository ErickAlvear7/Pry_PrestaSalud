    ...
    public partial class FrmAgendarCitaMedica : Page
    {
        ...
        protected void btnLink_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string _token = new MethodApi().GetToken("https://api.eh.ehealthcenter.io/explorer/", _apikey);
                ...
                if (_token != "")
                {
                    ...
                    {
                        //GET ID CONTRACT
                        _idcont = new MethodApi().GetIdContract("https://api.eh.ehealthcenter.io/explorer/", _token);
                        //GET ID SERVICIOS
                        _idserv = new MethodApi().GetServicios("https://api.eh.ehealthcenter.io/explorer/", _idcont, _token);
                        //GET ID ESPECIALIDAD
                        _idespe = new MethodApi().GetEspecialidad("https://api.eh.ehealthcenter.io/explorer/", _token, _idcont);
                        ...
                        _idpatient = new MethodApi().PostCreatePatient("https://api.eh.ehealthcenter.io/explorer/", data, _token);
                    ...
                    string medicos = new MethodApi().GetMedicos("https://api.eh.ehealthcenter.io/explorer/", _token, "2025-02-14", _idpatient, _idserv, _idespe);
                    ...
                    _datalink = new MethodApi().Consultas("https://api.eh.ehealthcenter.io/explorer/", dataconsulta, _token);
