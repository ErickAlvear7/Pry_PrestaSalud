...
namespace Pry_PrestasaludWAP.CitaMedica
{
    public partial class FrmAgendarMediLink : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ViewState["CodigoTitular"] = idtitular;

            //*** ESTO DEBERIA IR EN EL BOTON POR QUE COMO SE HACE POSTBACK SE VUELVE A EJECUTAR EL LOAD Y VUELVE A GENERAR EL TOKEN OTRA VEZ
