<%@ Page Language="C#" AutoEventWireup="true" Inherits="Regiones_FrmProvinciaAdmin" Codebehind="FrmProvinciaAdmin.aspx.cs" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        ShowHeaderWhenEmpty="True" DataKeyNames="Codigo,CodMarca,Estado,CodRegion,Provincia">
                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                        <Columns>
                                            <asp:BoundField DataField="Region" HeaderText="Region" />
                                            <asp:BoundField DataField="Provincia" HeaderText="Provincia" />
                                            <asp:BoundField DataField="CodMarca" HeaderText="Cod. Marcación" />
