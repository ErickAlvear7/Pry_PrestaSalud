<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmRepFactOdonAdmin.aspx.cs" Inherits="Pry_PrestasaludWAP.Administrador.FrmRepFactOdonAdmin" %>
                            ...
                            <tr>
                                ...
                                <td style="width: 35%">
                                    <asp:DropDownList ID="DdlTipoReporte" runat="server" AutoPostBack="True" CssClass="form-control" Width="100%" TabIndex="4" OnSelectedIndexChanged="DdlTipoReporte_SelectedIndexChanged">
                                        ...
                                        <asp:ListItem Value="2">Facturación Prestadora</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                    ...
                    <ContentTemplate>
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <asp:Panel ID="pnlFacturacion" runat="server" Height="380px" ScrollBars="Vertical">
                                        <rsweb:ReportViewer ID="RptFacturacion" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                            WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" AsyncRendering="false" SizeToReportContent="true">
                                        </rsweb:ReportViewer>
                                    </asp:Panel>
                                </td>
                                <td></td>
