<%@ Page Language="C#" AutoEventWireup="true" Inherits="Regiones_FrmCiudadAdmin" Codebehind="FrmCiudadAdmin.aspx.cs" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        ShowHeaderWhenEmpty="True" DataKeyNames="Codigo,CodProv,Ciudad,Estado">
