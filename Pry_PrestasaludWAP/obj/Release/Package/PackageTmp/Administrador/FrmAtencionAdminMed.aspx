<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmAtencionAdminMed.aspx.cs" Inherits="Pry_PrestasaludWAP.Administrador.FrmAtencionAdminMed" %>
                    ...
                    <ContentTemplate>
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="ImgBuscar" runat="server" Height="25px" ImageUrl="~/Botones/Buscar.png" OnClick="ImgBuscar_Click" TabIndex="4" />
                                </td>
                            </tr>
                            <tr>
                                <td></td>
