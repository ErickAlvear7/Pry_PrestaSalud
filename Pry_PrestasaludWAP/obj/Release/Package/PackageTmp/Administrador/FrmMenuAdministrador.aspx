<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmMenuAdministrador.aspx.cs" Inherits="Pry_PrestasaludWAP.Administrador.FrmMenuAdministrador" %>
...
<head runat="server">
    ...
    <script type="text/jscript">
        ...
        function hideLeftPanel() {
            ...
            if (oculto == parent.document.getElementById('MenuAdmin').cols) {
                parent.document.getElementById('MenuAdmin').cols = '3%,*'
            } else {
                parent.document.getElementById('MenuAdmin').cols = '18%,*'
            }
        }
        ...
        <div style="text-align: left">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="border-style: none; height: 100%; width: 200px;">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center">
                        <asp:Label ID="LblUsuario" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="Aqua" Text="Label"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td style="vertical-align: top; height: 450px; text-align: left;">
                        <asp:Panel ID="pnlMenu" runat="server" Height="450px" ScrollBars="Vertical">
                            <asp:TreeView ID="TrvMenu" runat="server" OnSelectedNodeChanged="TrvMenu_SelectedNodeChanged" ImageSet="Arrows" OnTreeNodePopulate="TrvMenu_TreeNodePopulate">
                                <HoverNodeStyle Font-Underline="True" ForeColor="#5555DD" />
                                <Nodes>
                                    <asp:TreeNode PopulateOnDemand="True" SelectAction="Expand" Text="Administrador" Value="Administrador"></asp:TreeNode>
                                </Nodes>
