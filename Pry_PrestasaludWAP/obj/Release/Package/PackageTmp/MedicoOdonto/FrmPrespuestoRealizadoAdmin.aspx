<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmPrespuestoRealizadoAdmin.aspx.cs" Inherits="Pry_PrestasaludWAP.MedicoOdonto.FrmPrespuestoRealizadoAdmin" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        ShowHeaderWhenEmpty="True" DataKeyNames="CodigoCabecera,Paciente,Medico,TituCodigo,BeneCodigo,CodigoPrestadora">
