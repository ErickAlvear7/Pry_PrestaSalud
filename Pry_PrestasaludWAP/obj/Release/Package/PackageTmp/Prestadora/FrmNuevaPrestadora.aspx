<%@ Page Language="C#" AutoEventWireup="true" Inherits="Prestadora_FrmNuevaPrestadora" CodeBehind="FrmNuevaPrestadora.aspx.cs" %>
                        ...
                        <ContentTemplate>
                            <table style="width: 100%; height: 100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlSector" runat="server" CssClass="form-control" TabIndex="2" Width="100%">
                                        </asp:DropDownList>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chkEstado" runat="server" AutoPostBack="True" Checked="True" CssClass="form-control" OnCheckedChanged="chkEstado_CheckedChanged" TabIndex="17" Visible="False" />
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
