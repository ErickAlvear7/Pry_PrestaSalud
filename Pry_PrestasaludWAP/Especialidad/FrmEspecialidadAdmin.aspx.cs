...
public partial class Especialidad_FrmEspecialidadAdmin : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lbltitulo.Text = "Administrar Especialidades Odontológicas";
    ...
    protected void funCargaMantenimiento()
    {
        try
        {
            ...
            objparam[0] = 0;
            dt = new Conexion(2, "").funConsultarSqls("sp_CargarEspecialidadAdmin", objparam);
    ...
    {
        Response.Redirect("FrmNuevaEspecialidad.aspx?Tipo=" + "N" + "&Codigo=0");
    }
    ...
    protected void btnselecc_Click(object sender, ImageClickEventArgs e)
    {
        ...
        String strCodigoEspe = grdvDatos.DataKeys[intIndex].Values["Codigo"].ToString();
        Response.Redirect("FrmNuevaEspecialidad.aspx?Tipo=" + "M" + "&Codigo=" + strCodigoEspe);
    }
    #endregion
}