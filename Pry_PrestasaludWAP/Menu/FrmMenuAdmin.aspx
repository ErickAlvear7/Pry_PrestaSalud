<%@ Page Language="C#" AutoEventWireup="true" Inherits="Menu_FrmMenuAdmin" CodeBehind="FrmMenuAdmin.aspx.cs" %>
                ...
                <asp:UpdatePanel ID="updPrincipal" runat="server">
                    <ContentTemplate>
                        ...
                        <table class="table table-bordered table-condensed table-hover table-responsive">
                            <tr>
                                <td>
                                    <asp:Panel ID="pnlDatos" runat="server" ScrollBars="Auto" Height="350px">
                                        <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                            CssClass="table table-condensed table-bordered table-hover table-responsive"
                                            DataKeyNames="Codigo" OnPageIndexChanging="grdvDatos_PageIndexChanging">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Editar">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnselecc" runat="server" Height="15px" ImageUrl="~/Botones/modificar.png" OnClick="btnselecc_Click" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                            </Columns>
