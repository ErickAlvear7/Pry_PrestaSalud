<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmPrestadoraExamenAdmin.aspx.cs" Inherits="Pry_PrestasaludWAP.Examenes.FrmPrestadoraExamenAdmin" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GrdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        ShowHeaderWhenEmpty="True" DataKeyNames="CodigoCita,TituCodigo,BeneCodigo,FechaCodigo,CodigoEXSO" OnRowDataBound="GrdvDatos_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Ausente">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="BtnAusente" runat="server" Height="20px" ImageUrl="~/Botones/ausente.png" OnClick="BtnAusente_Click" OnClientClick="if ( !confirm('Esta Seguro de registrar Ausente?')) return false;" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                        </Columns>
