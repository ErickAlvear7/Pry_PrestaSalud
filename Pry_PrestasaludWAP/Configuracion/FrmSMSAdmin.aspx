<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmSMSAdmin.aspx.cs" Inherits="Pry_PrestasaludWAP.Configuracion.FrmSMSAdmin" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        ShowHeaderWhenEmpty="True" DataKeyNames="Codigo,CodigoCamp">
