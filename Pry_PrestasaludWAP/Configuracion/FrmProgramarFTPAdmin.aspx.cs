...
{
    public partial class FrmProgramarFTPAdmin : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lbltitulo.Text = "Administrar Configurar-FTP";
        ...
        {
            Response.Redirect("FrmConfigurarFTP.aspx?CodigoCamp=0");
        }
        protected void btnselecc_Click(object sender, ImageClickEventArgs e)
        {
            GridViewRow gvRow = (GridViewRow)(sender as Control).Parent.Parent;
            int intIndex = gvRow.RowIndex;
            String strCodigoCamp = grdvDatos.DataKeys[intIndex].Values["CodigoCamp"].ToString();
            Response.Redirect("FrmConfigurarFTP.aspx?CodigoCamp=" + strCodigoCamp, true);
        }
        #endregion
    }
}