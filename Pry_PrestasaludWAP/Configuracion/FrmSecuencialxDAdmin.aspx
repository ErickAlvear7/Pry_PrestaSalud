<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmSecuencialxDAdmin.aspx.cs" Inherits="Pry_PrestasaludWAP.Configuracion.FrmSecuencialxDAdmin" %>
                                ...
                                <td>
                                    <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Secuencial" HeaderText="Secuencial" />
