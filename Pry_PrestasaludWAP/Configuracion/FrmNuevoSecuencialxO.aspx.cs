...
{
    public partial class FrmNuevoSecuencialxO : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Tables[0].Rows[0][0].ToString() == "") Response.Redirect("FrmSecuencialxOAdmin.aspx?MensajeRetornado='Guardado con Éxito'", true);
        ...
        {
            Response.Redirect("FrmSecuencialxOAdmin.aspx", true);
        }
        #endregion
    }
}