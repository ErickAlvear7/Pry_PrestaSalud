<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmProgramarFTPAdmin.aspx.cs" Inherits="Pry_PrestasaludWAP.Configuracion.FrmProgramarFTPAdmin" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        ShowHeaderWhenEmpty="True" DataKeyNames="CodigoCamp">
                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                        <Columns>
                                            <asp:BoundField DataField="Cliente" HeaderText="Cliente" />
                                            <asp:BoundField DataField="Ruta" HeaderText="Ruta_Archivo" />
                                            <asp:BoundField DataField="Nombre" HeaderText="Nombre_Archivo" />
