...
{
    public partial class FrmSecuencialxOAdmin : System.Web.UI.Page
    {
        #region Variables
        ...
        {
            Response.Redirect("FrmNuevoSecuencialxO.aspx?Codigo=0");
        }
        ...
        protected void btnselecc_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("FrmNuevoSecuencialxO.aspx?Codigo=" + strCodigo, true);
        }
        #endregion
    }
}