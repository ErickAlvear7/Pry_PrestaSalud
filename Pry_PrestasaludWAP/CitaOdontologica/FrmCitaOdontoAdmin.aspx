<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCitaOdontoAdmin.aspx.cs" Inherits="Pry_PrestasaludWAP.CitaOdontologica.FrmCitaOdontoAdmin" %>
                        ...
                        <table class="table table-bordered table-condensed table-hover table-responsive">
                            <tr>
                                ...
                                <td style="width: 20%; text-align: center;">
                                    <asp:Button ID="btnBuscar" runat="server" Text="Buscar" CssClass="button" OnClick="btnBuscar_Click" TabIndex="2" />
                                </td>
                                <td style="width: 5%"></td>
                            </tr>
                        </table>
                                ...
                                <td>
                                    <asp:Panel ID="pnlDatos" runat="server" Height="450px" ScrollBars="Vertical">
                                        <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                            ...
                                            ShowHeaderWhenEmpty="True" DataKeyNames="Codigo,CodigoProducto" TabIndex="3" OnRowDataBound="grdvDatos_RowDataBound">
                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                            <Columns>
                                                <asp:BoundField DataField="NumeroDocumento" HeaderText="Indentificación" />
