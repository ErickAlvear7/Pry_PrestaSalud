...
{
    public partial class FrmActualizarDatosO : Page
    {
        #region Variables
        ...
        protected void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.Tables[0].Rows[0][0].ToString() == "")
                    ScriptManager.RegisterStartupScript(this, GetType(), "pop", "javascript:window.opener.location='FrmAgendarCitaOdonto.aspx?CodigoTitular=" + ViewState["CodTitular"].ToString() + "&CodigoProducto=" + ViewState["CodProducto"].ToString() + "&MensajeRetornado=Actualizado con Éxito" + "';window.close();", true);
