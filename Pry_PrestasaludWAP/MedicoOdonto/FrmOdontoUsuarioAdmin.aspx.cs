...
{
    public partial class FrmOdontoUsuarioAdmin : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lbltitulo.Text = "Asignar Usuario - Odontólogo";
        ...
        protected void imgAsignarUsu_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                Response.Redirect("FrmNuevoUsuarioOdonto.aspx?CodigoMedico=" + strCodigomedico + "&CodigoUsuario=" + strCodigousu);
            }
            catch (Exception ex)
            {
                lbltitulo.Text = ex.ToString();
