<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptReporteFacturacion.aspx.cs" Inherits="Pry_PrestasaludWAP.MedicoOdonto.RptReporteFacturacion" %>
                                ...
                                <td>
                                    <asp:Panel ID="pnlFacturacion" runat="server" Height="310px" ScrollBars="Vertical">
                                        <rsweb:ReportViewer ID="rptFacturacion" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                            ...
                                            <LocalReport ReportPath="Reports\RptFacturaPrestaOdonto.rdlc">
                                            </LocalReport>
                                        </rsweb:ReportViewer>
                                    </asp:Panel>
                                </td>
