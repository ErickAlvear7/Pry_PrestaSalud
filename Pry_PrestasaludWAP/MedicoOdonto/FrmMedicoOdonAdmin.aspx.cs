...
{
    public partial class FrmMedicoOdonAdmin : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lbltitulo.Text = "Administrar Médicos Odontológico";
        ...
        {
            Response.Redirect("FrmNuevoMedicoOdon.aspx?Tipo=" + "N" + "&Codigo=0");
        }
        protected void btnselecc_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("FrmNuevoMedicoOdon.aspx?Tipo=" + "M" + "&Codigo=" + strCodigoMedico);
        }
