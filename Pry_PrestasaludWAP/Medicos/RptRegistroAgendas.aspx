<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptRegistroAgendas.aspx.cs" Inherits="Pry_PrestasaludWAP.Medicos.RptRegistroAgendas" %>
                ...
                <asp:UpdatePanel ID="updReporte" runat="server">
                    <ContentTemplate>
                        <table style="width: 100%">
                            <tr>
                                <td>
                                    <rsweb:ReportViewer ID="rptCitasMedicas" runat="server" Font-Names="Verdana" Font-Size="8pt" 
                                        WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="933px" AsyncRendering="false" SizeToReportContent="true">
                                        <LocalReport ReportPath="Reports\RptAgendasMedicas.rdlc">
                                        </LocalReport>
                                    </rsweb:ReportViewer>
                                </td>
                            </tr>
