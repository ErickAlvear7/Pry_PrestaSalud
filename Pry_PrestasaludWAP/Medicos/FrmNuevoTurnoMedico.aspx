<%@ Page Language="C#" AutoEventWireup="true" Inherits="Medicos_FrmNuevoTurnoMedico" CodeBehind="FrmNuevoTurnoMedico.aspx.cs" %>
                                ...
                                <tr>
                                    ...
                                    <ContentTemplate>--%>
                                        <table style="width: 100%" class="table table-bordered table-responsive">
                                                        ...
                                                        <asp:GridView ID="grdvDatos" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-bordered table-hover table-responsive" DataKeyNames="Codigo" ShowHeaderWhenEmpty="True" Width="100%" OnRowDataBound="grdvDatos_RowDataBound" TabIndex="8">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Eliminar">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="imgVer" runat="server" Height="15px" ImageUrl="~/Botones/eliminar.png" OnClick="imgVer_Click" />
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                            </Columns>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <asp:Panel ID="pnlHorarios" runat="server" Height="150px" ScrollBars="Vertical" Visible="false" GroupingText="Horarios Asignados">
                                                        <asp:GridView ID="grdvHorarios" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-bordered table-hover table-responsive" ShowHeaderWhenEmpty="True" Width="100%" PageSize="5">
                                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                            <Columns>
                                                                <asp:BoundField DataField="Dia" HeaderText="Día" />
                                                                <asp:BoundField DataField="HoraInicio" HeaderText="Hora Desde" />
                                                                <asp:BoundField DataField="HoraFin" HeaderText="Hora Hasta" />
                                                            </Columns>
                                                            <RowStyle Font-Size="X-Small" />
                                                        </asp:GridView>
                                                    </asp:Panel>
