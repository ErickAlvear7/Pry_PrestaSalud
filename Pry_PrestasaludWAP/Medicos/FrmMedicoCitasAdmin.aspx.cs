namespace Pry_PrestasaludWAP.Medicos
{
    ...
    public partial class FrmMedicoCitasAdmin : Page
    {
        #region Variables
        ...
        string fechaCita = "", horaSistema = "", fechaActual = "", strResponse = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lbltitulo.Text = "Atención Citas - Médicas";
        ...
        protected void funCargaMantenimiento()
        {
            try
            {
                ...
                objparam[2] = 115;
                dt = new Conexion(2, "").funConsultarSqls("sp_ConsultaDatos", objparam);
                if (dt.Tables[0].Rows.Count > 0) lbltitulo.Text = "Atención Citas - Médicas " + dt.Tables[0].Rows[0][0].ToString();
            }
            catch (Exception ex)
            {
        ...
        protected void btnselecc_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("FrmAtencionCitaMedica.aspx?CodigoCita=" + strcodigoCita + "&CodigoTitu=" + strtituCodigo + "&CodigoBene=" + strbeneCodigo, true);
        }
        protected void grdvDatos_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowIndex >= 0)
                {
                    ...
                    string[] hora = e.Row.Cells[4].Text.Split(new char[] { '-' });
                    ...
                    imgAusent = (ImageButton)(e.Row.Cells[7].FindControl("imgausente"));
        ...
        protected void imgausente_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                GridViewRow gvRow = (GridViewRow)(sender as Control).Parent.Parent;
                //int intIndex = gvRow.RowIndex;
                string strcodigoCita = grdvDatos.DataKeys[gvRow.RowIndex].Values["CodigoCita"].ToString();
