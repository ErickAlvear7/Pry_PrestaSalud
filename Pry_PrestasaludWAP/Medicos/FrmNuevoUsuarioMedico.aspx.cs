...
{
    public partial class FrmNuevoUsuarioMedico : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objparam[0] = ddlAsignarUsuario.SelectedValue == "0" ? 1 : 0;
                ...
                if (dt.Tables[0].Rows.Count > 0)
                {
                    if (dt.Tables[0].Rows[0][0].ToString() == "") Response.Redirect("FrmMedicoUsuarioAdmin.aspx?MensajeRetornado='Usuario Asignado con Éxito'", true);
        ...
        {
            Response.Redirect("FrmMedicoUsuarioAdmin.aspx", true);
        }
