...
public partial class Medicos_FrmNuevoTurnoMedico : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lbltitulo.Text = "Asignar Turnos a Médicos";
    ...
    private void funClearObject()
    {
        ...
        grdvDatos.DataBind();
        grdvHorarios.DataSource = null;
        grdvHorarios.DataBind();
        pnlHorarios.Visible = false;
        ViewState["DetectarCambio"] = "NO";
    }
    #endregion
    ...
    protected void btnGrabar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dt = new Conexion(2, "").FunInsertarTurnoMedico(objparam, (DataTable)ViewState["tblTurnoMedico"]);
    ...
    protected void imgVer_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            int intIndex = gvRow.RowIndex;
            int codigo = int.Parse(grdvDatos.DataKeys[intIndex].Values["Codigo"].ToString());
            //string strTurno = grdvDatos.Rows[intIndex].Cells[0].Text;
            Array.Resize(ref objparam, 3);
            objparam[0] = codigo;
            objparam[1] = "";
            objparam[2] = 3;
