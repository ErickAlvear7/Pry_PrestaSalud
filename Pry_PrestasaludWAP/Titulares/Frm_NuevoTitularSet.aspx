<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Frm_NuevoTitularSet.aspx.cs" Inherits="Pry_PrestasaludWAP.Titulares.Frm_NuevoTitularSet" %>
                            ...
                            <div class="table-responsive">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6">
                                            <asp:TextBox ID="txtDireccionBen" runat="server" onkeydown="return (event.keyCode!=13);" Width="100%" CssClass="form-control upperCase" MaxLength="80" Height="50px" TextMode="MultiLine" TabIndex="33"></asp:TextBox>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="7">
                                            <asp:Panel ID="pnlBeneficiarios" runat="server" Height="250px" ScrollBars="Vertical" GroupingText="Beneficarios">
                                                <asp:GridView ID="grdvDatos" runat="server" AutoGenerateColumns="False"
                                                    CssClass="table table-condensed table-bordered table-hover table-responsive" DataKeyNames="CodigoBen,TipoDocumentoBen,NumeroDocumentoBen,GeneroBen,EstadoCivilBen,FechaNacimientoBen,ProvinciaBen,CiudadBen,DireccionBen,FonoCasaBen,FonoOficinaBen,CelularBen,EmailBen,ParentescoCod,Estado,PrimerNombre,SegundoNombre,PrimerApellido,SegundoApellido" ShowHeaderWhenEmpty="True" Width="100%" TabIndex="43">
