...
{
    public partial class Frm_NuevoTitularSet : Page
    {
        #region Variables
        ...
        protected void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Tables[0].Rows[0][0].ToString() == "") Response.Redirect("Frm_TitularAdminSet.aspx?MensajeRetornado='Guardado con Éxito'&codProducto=" + ViewState["CodProducto"].ToString(), false);
        ...
        {
            Response.Redirect("Frm_TitularAdminSet.aspx?codProducto=" + ViewState["CodProducto"].ToString(), true);
        }
