...
public partial class Horarios_FrmHorarioAdmin : System.Web.UI.Page
{
    #region Variables
    ...
    protected void funCargaMantenimiento()
    {
        try
        {
            ...
            objparam[0] = 0;
            dt = new Conexion(2, "").funConsultarSqls("sp_CargarHorarioAdmin", objparam);
    ...
    {
        Response.Redirect("FrmNuevoHorario.aspx?Tipo=" + "N" + "&Codigo=0");
    }
    ...
    protected void btnselecc_Click(object sender, ImageClickEventArgs e)
    {
        ...
        String strCodigoHora = grdvDatos.DataKeys[intIndex].Values["Codigo"].ToString();
        Response.Redirect("FrmNuevoHorario.aspx?Tipo=" + "M" + "&Codigo=" + strCodigoHora);
    }
    #endregion
}