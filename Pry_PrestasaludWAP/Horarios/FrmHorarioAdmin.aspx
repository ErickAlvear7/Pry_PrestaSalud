<%@ Page Language="C#" AutoEventWireup="true" Inherits="Horarios_FrmHorarioAdmin" Codebehind="FrmHorarioAdmin.aspx.cs" %>
                                ...
                                <td>
                                    <asp:GridView ID="grdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="HoraFin" HeaderText="Hora_Fin" />
