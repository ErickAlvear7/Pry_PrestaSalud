...
{
    public partial class FrmPrestadoraOdonAdmin : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void btnselecc_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("FrmNuevaPrestadoraOdon.aspx?Tipo=" + "E" + "&Codigo=" + strCodigo);
        }
        protected void btnNuevo_Click(object sender, EventArgs e)
        {
            Response.Redirect("FrmNuevaPrestadoraOdon.aspx?Tipo=" + "N" + "&Codigo=0");
        }
        #endregion
    }
}