<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Frm_RepGerencialV1.aspx.cs" Inherits="Pry_PrestasaludWAP.Reportes.Frm_RepGerencialV1" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:UpdatePanel ID="UpdReporViewer" runat="server">
                                <ContentTemplate>
                                    <asp:Panel ID="pnlFacturacion" runat="server" Height="510px" ScrollBars="Auto" Visible="false">
